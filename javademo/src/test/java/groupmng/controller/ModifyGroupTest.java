...
public class ModifyGroupTest {
    ...
    public void test01() throws Exception {
        ...
        response = GroupMngClient.modifyGroup(group01, "", "", "");
        assertTrue(JSONObject.parseObject(response.getBody()).getInteger("code") == 503);

        response = GroupMngClient.modifyGroup(group01, group01.getGroupName() + "_new", group01.getAnnouncement() + "_new", group01.getAvatar() + "_new");
